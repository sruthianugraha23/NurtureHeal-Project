  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image source={require('/Users/sruthianugraha/NurtureHeal-proj/Home/assets/images/cancelled.png')} style={styles.image} />
        <Text style={styles.noAppointmentText}>You have not complete any session</Text>
      </View>
    </View>
  );
};
